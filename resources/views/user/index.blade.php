                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-block text-nowrap">
                                    ...
                                    <button type="button" class="btn btn-label-danger btn-sm item-delete" onclick="if(confirm('Are you sure you want to delete?')){showLoading();window.location.href='{{ route('user.destroy', $row) }}'}" title="Delete">
